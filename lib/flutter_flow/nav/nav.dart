...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? LogInWidget() : OnboardingWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          name: 'AddInCube',
          path: '/addInCube',
          builder: (context, params) => AddInCubeWidget(),
        ),
        FFRoute(
          name: 'InfromationProfile',
          path: '/infromationProfile',
          builder: (context, params) => InfromationProfileWidget(),
        ),
        FFRoute(
          name: 'ReportPage',
          path: '/reportPage',
